...
public class PerspectiveCamera extends Camera {
    ...
    public void getRay(Ray outRay, float inU, float inV) {
        ...
        origin.set(this.getViewPoint());
        dirVector.addMultiple(-1.0*this.getProjDistance(), w);
        dirVector.addMultiple(tempU, u);
        dirVector.addMultiple(tempV, v);

        outRay.set(origin, dirVector);
